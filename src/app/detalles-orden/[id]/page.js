              ...
              {[...products,...products].filter(product.id===1).map((product) => (
                ...
                >
                  ...
                  <div className="sm:col-span-12 md:col-span-7">
                    ...
                    <div className="mt-5">
                        {/* Lista horizontal con las imagenes de todos los productos en el array products */}
                        ...
                        <div className="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 xl:gap-x-8">
                            {products.map((product) => (
                                <div key={product.id} className="group relative">
                                    <div className="w-full rounded-lg overflow-hidden group-hover:opacity-75 lg:h-72 xl:h-80">
                                        <Image
