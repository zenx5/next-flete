                              ...
                              {category.featured.map((item) => (
                                <div key={item.name} className="group relative">
                                  <div className="aspect-h-1 aspect-w-1 overflow-hidden rounded-md bg-gray-100 group-hover:opacity-75">
                                    <img width={200} height={200} src={item.imageSrc} alt={item.imageAlt} className="h-96 object-cover object-center, " />
                                  </div>
                          ...
                          <div className="flex h-full justify-center space-x-8">
                            ...
                            {/* <div className="grid grid-cols-4 gap-x-8 gap-y-10 py-16">
                                              {category.featured.map((item) => (
                                                <div key={item.name} className="group relative">
                                                  <div className="aspect-h-1 aspect-w-1 overflow-hidden rounded-md bg-gray-100 group-hover:opacity-75">
                                                    <Image width={300} height={300} src={item.imageSrc} alt={item.imageAlt} className="aspect-h-1 aspect-w-1 h-44 w-autoobject-cover object-center, " />
                                                    {/* <img
																										src={item.imageSrc}
																										alt={item.imageAlt}
