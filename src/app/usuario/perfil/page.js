...
export default function ProfilePage(){
    ...
    return <div className="flex flex-row p-10 gap-5 bg-gray-200">
        <div className="border border-blue-300 p-4 rounded-lg flex flex-col items-center shadow w-3/12 lg:w-2/12 h-fit bg-white overflow-x-hidden">
        ...
        <div className="border border-blue-300 p-4 rounded-lg flex flex-col items-center shadow w-9/12 lg:w-10/12 bg-white gap-2">
            <h3 className="font-bold">Datos Personales</h3>
            <div className="flex flex-col lg:flex-row w-full gap-4 mb-5">
                <div className="flex flex-col justify-start w-full lg:w-1/2 gap-2">
            ...
            <div className="flex flex-row w-full gap-4 mb-5 items-center">
                <div className="flex flex-col justify-start w-2/3 lg:1/2 gap-2">
                    <LineInput label="Contraseña" />
                    <LineInput label="Repetir Contraseña" />
                </div>
                <div className="flex flex-col w-1/3 lg:w-1/2 gap-2 items-center">
