...
export default function RegisterPage() {
    ...
    return <div className="flex flex-col">
        ...
        <span className="flex flex-col border-t border-blue-500 mt-4">
            ...
            <button className="text-blue-500 border border-blue-500 p-3 my-4 rounded">Enviar</button>
            <a href="#" className="text-blue-500 text-center border border-blue-500 p-3  rounded">Acceder</a>
        </span>
    </div>
}