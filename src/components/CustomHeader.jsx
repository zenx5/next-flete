                        ...
                        <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-black pb-12 shadow-xl">
                            ...
                            <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                                <div className="flow-root">
                                    <button onClick={() => { router.push('/consulta'); setMobileMenuOpen(false) }} className="-m-2 block p-2 font-medium text-white">
                                        Consultar
                                    </button>
                                </div>
                                <div className="flow-root">
                                    <button onClick={() => { router.push('/usuario/registro'); setMobileMenuOpen(false) }} className="-m-2 block p-2 font-medium text-white">
                                        Crear cuenta
                                    </button>
                                </div>
