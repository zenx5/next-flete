                        ...
                        <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                            ...
                            <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                                {navigation.pages.map((page) => (
                                    <div key={page.name} className="flow-root">
                                        <button onClick={() => {router.push(page.href);setMobileMenuOpen(false)}} className="-m-2 block p-2 w-full font-medium text-gray-900">
                                            {page.name}
                                        </button>
                                    </div>
                                ))}
                            ...
                            <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                                <div className="flow-root">
                                    <button onClick={() => {router.push('/usuario/registro');setMobileMenuOpen(false)}} className="-m-2 block p-2 font-medium text-gray-900 w-full">
                                        Crear cuenta
                                    </button>
                                </div>
                                <div className="flow-root">
                                    <button onClick={() => {router.push('/usuario/acceder');setMobileMenuOpen(false)}} className="-m-2 block p-2 w-full font-medium text-gray-900">
                                        Ingresar
                                    </button>
                                </div>
                            </div>
