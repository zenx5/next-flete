...
export default function PopupCart({ onClose }) {
    ...
    return <div className="flex justify-end mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-0">
        <div className="p-5 bg-white w-1/4 shadow-xl border-2 border-gray-200 h-fit z-20 rounded-xl">
