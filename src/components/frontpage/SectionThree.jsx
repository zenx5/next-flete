...
export default function SectionThree() {
    ...
    <div className="flex flex-col pt-12 md:pt-16">
      <div className="px-14 md:px-20 py-4">
        <p className="text-3xl">Sobre Nosotros</p>
      </div>
      <div className="px-14 md:px-20">
        ...
        <button className="justify-center bg-blue-900 hover:bg-blue-700 text-white w-40 font-bold py-2 px-4">Ver Más</button>
      </div>
    </div>
